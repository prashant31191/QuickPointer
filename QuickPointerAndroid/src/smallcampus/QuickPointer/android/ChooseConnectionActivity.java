...
/**
 * Activity which displays an interface for choosing the connection
 */
public class ChooseConnectionActivity extends Activity {
	/**
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mIPView = (EditText) findViewById(R.id.IPText);
		mIPView.setText(mEmail);

		mPasswordView = (EditText) findViewById(R.id.bluetoothMacText);
		mPasswordView
		...
		findViewById(R.id.TCPConnectBtn).setOnClickListener(
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.choose_connection, menu);
		return true;
	}
	...
	public void attemptLogin() {
		...
		mEmail = mIPView.getText().toString();
